...
- Terminology pass status: `SEEDED_INTERNAL_REVISIONS_APPLIED_NAMED_REVIEW_PENDING`
...
4. Keep technical review routing separate and pending until reviewer coverage exists.

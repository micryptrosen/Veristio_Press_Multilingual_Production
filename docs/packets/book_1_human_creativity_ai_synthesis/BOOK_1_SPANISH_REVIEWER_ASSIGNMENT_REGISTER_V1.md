...
| native-language reviewer | NOT_ASSIGNED | NATIVE_REVIEW_PACKET_READY_REVIEWER_PENDING | Draft V2 and native-review packet may be routed for assignment when a real reviewer is identified. | Native review result claims and release readiness. | No named reviewer source in repo truth. |

...
The Multilingual Production repo has a Book 1 Spanish terminology seed, reviewer workflow, assignment register, coverage decision, and provisional review boundary. No named human reviewers are assigned. Provisional internal review is allowed for draft-packet preparation only.
...
| Translation status | NOT_STARTED | No target-language prose was produced in this tranche. |

## Required Conditions On The Next Draft Packet

- State that reviewer coverage is provisional and draft-only.

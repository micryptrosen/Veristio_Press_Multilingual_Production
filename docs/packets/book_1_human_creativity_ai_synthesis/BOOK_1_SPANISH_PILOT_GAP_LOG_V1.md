...
| BOOK1-ES-GAP-003 | Spanish glossary | SEEDED_PENDING_REVIEW | Book 1 Spanish terminology seed exists at `docs/packets/book_1_human_creativity_ai_synthesis/BOOK_1_SPANISH_TERMINOLOGY_SEED_V1.md`; terminology reviewer has not approved terms. | Assign terminology reviewer and approve, revise, or defer seeded terms before terminology readiness is claimed. |
...
| BOOK1-ES-GAP-008 | Reviewer availability | OPEN_BLOCKING | Reviewer workflow exists, but no Spanish terminology, native-language, technical, or final sync/proof reviewers are assigned in repo truth. | Assign or log owners for Spanish terminology, native-language, technical, and final sync/proof review. |

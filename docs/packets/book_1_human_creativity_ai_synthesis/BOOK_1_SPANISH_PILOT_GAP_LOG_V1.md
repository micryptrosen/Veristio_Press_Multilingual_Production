...
| BOOK1-ES-GAP-012 | Draft review queue | READY_FOR_NATIVE_LANGUAGE_REVIEW_WITH_CONDITIONS | Draft V2, revision resolution log, native-review prep packet, and post-revision status decision exist for Chapter 1. | Assign named reviewers and complete terminology, native-language, technical, final sync/proof, metadata/ISBN, and release gate reviews before downstream readiness claims. |

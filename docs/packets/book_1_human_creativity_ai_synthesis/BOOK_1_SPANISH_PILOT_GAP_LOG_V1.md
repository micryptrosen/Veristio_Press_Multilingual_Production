...
| BOOK1-ES-GAP-003 | Spanish glossary | INTERNAL_TERMINOLOGY_REVISIONS_APPLIED_NAMED_REVIEW_PENDING | Book 1 Spanish terminology seed, internal terminology pass, Draft V2, and revision resolution log exist; terminology reviewer has not approved terms. | Obtain terminology reviewer/operator decision before terminology readiness is claimed. |
...
| BOOK1-ES-GAP-008 | Reviewer availability | NATIVE_REVIEW_PACKET_READY_REVIEWER_PENDING | Native-review assignment, instructions, checklist, and status decision exist; no named native-language reviewer is assigned. | Assign named reviewers before terminology/native/technical/final sync/proof result claims or release readiness can be claimed. |
...
| BOOK1-ES-GAP-012 | Draft review queue | READY_FOR_NATIVE_REVIEW_WITH_CONDITIONS | Draft V2, native-review prep packet, assignment, instructions, checklist, and status decision exist for Chapter 1. | Assign named reviewer and perform native-language review before any native-review result is claimed. |

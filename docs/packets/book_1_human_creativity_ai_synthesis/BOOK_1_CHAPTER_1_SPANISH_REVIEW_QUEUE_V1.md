...
`OPEN_REVIEW_QUEUE_DRAFT_V2_READY_FOR_NATIVE_PREP`
...
| B1-CH01-ES-RQ-002 | native-language review | READY_FOR_ASSIGNMENT_WITH_CONDITIONS | native review completion | Native-review prep packet exists; no named native-language reviewer is assigned. |
...
This queue routes review work only. It records an internal provisional terminology/draft pass and V2 revision prep; it does not claim native-language review completion, human reviewer signoff, technical review completion, final sync/proof completion, publication readiness, or release approval.
